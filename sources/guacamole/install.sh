...
sed -i "s#port=3389#port=tcp://127.0.0.1:5225##" /etc/xrdp/xrdp.ini # RDP localhost
...
kwriteconfig5 --file "/root/.config/plasma-org.kde.plasma.desktop-appletsrc" --group 'Containments' --group '1' --group 'Wallpaper' --group 'org.kde.image' --group 'General' --key 'Image' "/workspace/wallpaper.png"
...
kwriteconfig5 --file kdeglobals --group "General" --key "Style" "Breeze Dark"
